...
constexpr CpuOp CpuOpsPage0[] = {
    ...
    { 0x34, "PSHS",      AddressingMode::Immediate,  5, 2 },
    { 0x35, "PULS",      AddressingMode::Immediate,  5, 2 },
    { 0x36, "PSHU",      AddressingMode::Immediate,  5, 2 },
    { 0x37, "PULU",      AddressingMode::Immediate,  5, 2 },
    ...
    { 0x48, "LSLA/ASLA", AddressingMode::Inherent ,  2, 1 },
    ...
    { 0x58, "LSLB/ASLB", AddressingMode::Inherent ,  2, 1 },
