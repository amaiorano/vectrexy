...
constexpr CpuOp CpuOpsPage0[] = {
    // clang-format off
    { 0x00, "NEG",       AddressingMode::Direct   ,  6, 2, "Negate accumulator" },
    { 0x01, "Illegal",   AddressingMode::Illegal  ,  1, 1, "Illegal" },
    { 0x02, "Illegal",   AddressingMode::Illegal  ,  1, 1, "Illegal" },
    { 0x03, "COM",       AddressingMode::Direct   ,  6, 2, "Complement accumulator" },
    ...
    { 0x0A, "DEC",       AddressingMode::Direct   ,  6, 2, "Decrement accumulator" },
    { 0x0B, "Illegal",   AddressingMode::Illegal  ,  1, 1, "Illegal" },
    { 0x0C, "INC",       AddressingMode::Direct   ,  6, 2, "Increment accumulator" },
    { 0x0D, "TST",       AddressingMode::Direct   ,  6, 2, "Test accumulator" },
    { 0x0E, "JMP",       AddressingMode::Direct   ,  3, 2, "Jump" },
    { 0x0F, "CLR",       AddressingMode::Direct   ,  6, 2, "Clear accumulator" },
    ...
    { 0x1F, "TFR",       AddressingMode::Inherent ,  7, 2, "Transfer (r1 size<=r2)" },
    ...
    { 0x60, "NEG",       AddressingMode::Indexed  ,  6, 2, "Negate accumulator" },
    { 0x61, "Illegal",   AddressingMode::Illegal  ,  1, 1, "Illegal" },
    { 0x62, "Illegal",   AddressingMode::Illegal  ,  1, 1, "Illegal" },
    { 0x63, "COM",       AddressingMode::Indexed  ,  6, 2, "Complement accumulator" },
    ...
    { 0x6A, "DEC",       AddressingMode::Indexed  ,  6, 2, "Decrement accumulator" },
    { 0x6B, "Illegal",   AddressingMode::Illegal  ,  1, 1, "Illegal" },
    { 0x6C, "INC",       AddressingMode::Indexed  ,  6, 2, "Increment accumulator" },
    { 0x6D, "TST",       AddressingMode::Indexed  ,  6, 2, "Test accumulator" },
    { 0x6E, "JMP",       AddressingMode::Indexed  ,  3, 2, "Jump" },
    { 0x6F, "CLR",       AddressingMode::Indexed  ,  6, 2, "Clear accumulator" },
    { 0x70, "NEG",       AddressingMode::Extended ,  7, 3, "Negate accumulator" },
    { 0x71, "Illegal",   AddressingMode::Illegal  ,  1, 1, "Illegal" },
    { 0x72, "Illegal",   AddressingMode::Illegal  ,  1, 1, "Illegal" },
    { 0x73, "COM",       AddressingMode::Extended ,  7, 3, "Complement accumulator" },
    ...
    { 0x7A, "DEC",       AddressingMode::Extended ,  7, 3, "Decrement accumulator" },
    { 0x7B, "Illegal",   AddressingMode::Illegal  ,  1, 1, "Illegal" },
    { 0x7C, "INC",       AddressingMode::Extended ,  7, 3, "Increment accumulator" },
    { 0x7D, "TST",       AddressingMode::Extended ,  7, 3, "Test accumulator" },
    { 0x7E, "JMP",       AddressingMode::Extended ,  3, 3, "Jump" },
    { 0x7F, "CLR",       AddressingMode::Extended ,  7, 3, "Clear accumulator" },
